...
vetsImportFile = 'UnverifiedVetInfo_20210712.csv'
vetsImportFileResults = 'UnverifiedVetInfo_Results_20210712.txt'
unverifiedVetInfoBucketFile = "UnverifiedVetInfoBuckets.txt"
...
def process(verbose):  
    ...
    headerLine = "Kyrios ID!Full Name!First!Middle!Last!License #!Vet State!Clinic State!# MedPro Responses!MedPro ID!MedPro State!In Universe!MedPro License!MedPro License Status\n"
        ...
        for line in vets:
            ...
            if len(row) >= 4:
                try:
                    ...
                    if vetState == 'UNK':
                        vetState = ''
                    clinicState = row[clinicStatePos].strip()
                    if clinicState == 'UNK':
                        clinicState = ''
                    ...
                    # If this returns 0 matches, use the state
                    # of the clinic and see if it matches.
                    if len(rv) == 0:
                        rv = hcps.search(stateOfLicense=clinicState, 
                                        lastName=vetLastName, 
                                        firstName=vetFirstName, 
                                        middleName=vetMiddleName
                                        )
                    ...
                    dataLine = f"{kyriosID}!{fullName}!{vetFirstName}!{vetMiddleName}!{vetLastName}!{vetLicenseNum}!{vetState}!{clinicState}!{len(rv)}!{vetMedproId}!{vetMedproState}!{vetInUniverse}!{vetMedproLicense}!{vetMedproLicenseStatus}\n"
